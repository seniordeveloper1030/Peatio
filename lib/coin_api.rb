module CoinAPI
  ...
  class BaseAPI
    ...
    #
    # Return real wallet balance for account
    #
    # @abstract Derived API clients must implemnt it
    # @return [BigDecimal]
    def walletbalance!
      method_not_implemented
    end
    ...
    %i[ load_balance load_deposit create_address create_withdrawal inspect_address walletbalance ].each do |method|
      class_eval <<-RUBY
