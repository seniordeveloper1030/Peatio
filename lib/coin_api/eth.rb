module CoinAPI
  class ETH < BaseAPI
    ...
    def walletbalance!(address)
      convert_from_base_unit(load_balance_of_address(address))
    end
    ...
    def create_withdrawal!(issue, recipient, amount, options = {})
      
      #add base coin issuer
      issuer = { address: currency.eth_coinbase, secret: currency.base_passphrase }
